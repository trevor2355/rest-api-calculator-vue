<template>
  <b-container>
    ...
    <TheEditUserModal :editModal='editModal' :key='editModal.id' @reset-editModal="resetEditModal" @get-all-users='getAllUsers'></TheEditUserModal>
    <TheDeleteModal key='deleteModal' :recordId='deleteRecordId' :username='deleteUsername' :entity='entity' @get-all-users='getAllUsers'/>
  </b-container>
</template>
<script>
