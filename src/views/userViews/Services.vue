    ...
    <div>
      <div>
        ...
        <input
          ...
          class="input"
        />
        <b-button @click="add" :disabled="additionSubtractionDisabled"
      ...
      <div>
        ...
        <input
          ...
          class="input"
        />
        <b-button @click="subtract" :disabled="additionSubtractionDisabled"
          >Request Service</b-button
        >
      ...
      <div>
        ...
        <input
          ...
          class="input"
        />
        <b-button @click="multiply" :disabled="multiplicationDivisionDisabled"
          >Request Service</b-button
        >
      ...
      <div>
        ...
        <input
          ...
          class="input"
        />
        <b-button @click="divide" :disabled="multiplicationDivisionDisabled"
          >Request Service</b-button
        >
      ...
      <div>
        ...
        <input
          ...
          class="input"
        />
        <b-button @click="squareRoot" :disabled="squareRootDisabled"
          >Request Service</b-button
        >
      ...
      <div>
        ...
        <input
          v-model="generateRandomStringVal"
          type="number"
          name="generateRandomStringVal"
          class="input"
        />
        <b-button
...
export default {
  ...
  methods: {
    ...
    add() {
      this.additionResult =
        parseFloat(this.additionVal1) + parseFloat(this.additionVal2);
      this.handleServiceRequest("addition", this.additionResult);
    },
    subtract() {
      this.subtractionResult =
        parseFloat(this.subtractionVal1) - parseFloat(this.subtractionVal2);
      this.handleServiceRequest("subtraction", this.subtractionResult);
    },
    multiply() {
      this.multiplicationResult =
        parseFloat(this.multiplicationVal1) *
        parseFloat(this.multiplicationVal2);
      this.handleServiceRequest("multiplication", this.multiplicationResult);
    },
    divide() {
      this.divisionResult =
        parseFloat(this.divisionVal1) / parseFloat(this.divisionVal2);
      ...
      fetch(`${this.$hostname}/api/services/randomstringgenerator`, options)
        ...
        .then(string => {
          ...
          this.handleServiceRequest(
            "random_string",
            this.randomStringGeneratorResult
          );
        })
        .catch(err => {
          console.log(err);
    ...
    findCostAndId(serviceName) {
      if (this.services) {
        let matchedService = this.services.filter(
